...
class ModelGene(PhenodigmTable):
    ...
    def addData(
        ...
        self.data.append(
            [gene_id, organism, symbol, name, altname, type, locus, withdrawn]
        )
...
class ModelModel(PhenodigmTable):
    ...
    def addData(
        ...
        source=None,
        species=None,
        genetic_background=None,
        life_stage=None,
        description=None,
    ):
        self.data.append(
            [id, source, species, genetic_background, life_stage, description]
        )
...
class ModelAssociation(PhenodigmTable):
    ...
    def addData(self, q, m, s_avg_norm, s_avg_raw, s_max_norm, s_max_raw, p1, p2):
        self.data.append([q, m, s_avg_norm, s_avg_raw, s_max_norm, s_max_raw, p1, p2])
