...
class PhenodigmModelDiseaseTests(unittest.TestCase):
    ...
    def test_score3(self):
        ...
        self.assertDelta(66.66, scores[0], msg="Mj and Dy are partial matches (avg)")
        self.assertDelta(100, scores[2], msg="Mj and Dy are partial matches (max)")
    ...
    def test_score4(self):
        ...
        self.assertDelta(50, scores[2], msg="Lower score because disease has hp0 (max)")
        self.assertDelta(
            50, scores[0], msg="Lower score because because disease has hp0 (avg)"
        )
